        ...
        <div class="navbar my-nav" role="navigation">
            ...
            <div class="collapse navbar-collapse pull-right" id="nav-menu">
                <ul class="nav navbar-nav " >
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/customerservice/customers.php'){ echo "active";}?>" href="customers.php">Customers</a></li>
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/customerservice/notification.php'){ echo "active";}?>" href="notification.php">Customer Notification</a></li>
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/customerservice/customerservicepersonel.php'){ echo "active";}?>" href="customerservicepersonel.php">Service Personel</a></li>
