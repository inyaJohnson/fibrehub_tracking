        ...
        <div class="navbar my-nav" role="navigation">
            ...
            <div class="collapse navbar-collapse pull-right" id="nav-menu">
                <ul class="nav navbar-nav">
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/marketers/fibrehub.php'){ echo "active";}?>" href="fibrehub.php">Home</a></li>
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/marketers/customers.php'){ echo "active";}?>" href="customers.php">Customers</a></li>
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/marketers/marketers.php'){ echo "active";}?>" href="marketers.php">Marketers</a></li>
                    <li><a  class="nav-font <?php if($_SERVER['SCRIPT_NAME'] === '/tracking/marketers/addprospect.php'){ echo "active";}?>" href="addprospect.php">Add Prospect</a></li>
